...
namespace LayoutManager {
	public partial class LayoutFrameWindow {
		...
		private void InitializeComponent() {
			...
			// menuItemLearnLayout
			// 
			this.menuItemLearnLayout.Index = 6;
			...
			// 
			this.menuItemConnectLayout.Index = 7;
			...
			// 
			this.menuItemEmergencyStop.Index = 8;
			...
			// 
			this.menuItemSuspendLocomotives.Index = 9;
			...
			// menuItemPolicies
			// 
			this.menuItemPolicies.Index = 11;
			...
			// 
			this.menuItemDefaultDriverParameters.Index = 12;
			...
			// 
			this.menuItemCommonDestinations.Index = 13;
			...
			// 
			this.menuItemManualDispatchRegions.Index = 14;
