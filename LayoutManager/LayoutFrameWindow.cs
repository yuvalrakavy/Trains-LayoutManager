	...
	public partial class LayoutFrameWindow : System.Windows.Forms.Form, ILayoutFrameWindow
	{
		...
		public LayoutFrameWindow() {
			...
			foreach(var area in LayoutModel.Areas) {
				...
				menuItemViewActivePhases.Checked = applicationState.ViewOnlyActivePhases;
		...
		private void doUIsetting(UIsettingEntry[] uiSetting) {
			foreach(UIsettingEntry aEntry in uiSetting) {
				...
				else if(aEntry is MenuSettingEntry) {
		...
		private void menuItemSetToDesignPhase_Click(object sender, EventArgs e) {
			EventManager.Event(new LayoutEvent<LayoutSelection, LayoutPhase>("change-phase", null, LayoutPhase.Planned));
		}

		private void menuItemSetToConstructionPhase_Click(object sender, EventArgs e) {
			EventManager.Event(new LayoutEvent<LayoutSelection, LayoutPhase>("change-phase", null, LayoutPhase.Construction));
		}

		private void menuItemSetToOperationalPhase_Click(object sender, EventArgs e) {
			EventManager.Event(new LayoutEvent<LayoutSelection, LayoutPhase>("change-phase", null, LayoutPhase.Operational));
		}
