...
namespace LayoutManager
{
	...
	public abstract class LayoutTool : Component
	{
		...
		public void LayoutView_ModelComponentClick(object sender, LayoutViewEventArgs e) {
			...
			LayoutHitTestResult	hitTestResult = view.HitTest(view.PointToClient(Control.MousePosition));
		...
		public void LayoutView_ModelComponentQueryDrop(object sender, LayoutViewEventArgs e) {
			...
			if(e.HitTestResult != null) {
				foreach(ModelComponent component in e.HitTestResult.Selection)
					EventManager.Event(new LayoutEvent(component, QueryDropEventName, null, e.DragEventArgs).SetFrameWindow(e.HitTestResult.FrameWindow));
			}
		}
		...
		public void LayoutView_ModelComponentDrop(object sender, LayoutViewEventArgs e) {
			foreach(ModelComponent component in e.HitTestResult.Selection)
				EventManager.Event(new LayoutEvent(component, DropEventName, null, e.DragEventArgs).SetFrameWindow(e.HitTestResult.FrameWindow));
		}
		...
		public void LayoutView_ModelComponentDragged(object sender, LayoutViewEventArgs e) {
			...
			if(e.HitTestResult != null) {
				foreach(ModelComponent component in e.HitTestResult.Selection) {
					object info = EventManager.Event(new LayoutEvent(component, QueryDragEventName, null, e).SetFrameWindow(e.HitTestResult.FrameWindow));
				...
				if(draggedObject != null) {
					LayoutDraggedObject draggedObjectDetails = draggedObject as LayoutDraggedObject;

					if(draggedObjectDetails != null) {
					...
					EventManager.Event(new LayoutEvent(components, DragDoneEventName, null, dropEffect).SetFrameWindow(e.HitTestResult.FrameWindow));
				}
			}
		}
		...
		protected virtual ContextMenu GetSelectionContextMenu(LayoutModelArea area, LayoutHitTestResult hitTestResult) {
			...
			EventManager.Event(new LayoutEvent(hitTestResult, ComponentContextMenuAddSelectionEntriesEventName, null, menu).SetFrameWindow(hitTestResult.FrameWindow));
		...
		protected virtual ContextMenu GetEmptySpotMenu(LayoutModelArea area, LayoutHitTestResult hitTestResult) {
			...
			EventManager.Event(new LayoutEvent(hitTestResult, ComponentContextMenuAddEmptySpotEntriesEventName, null, menu).SetFrameWindow(hitTestResult.FrameWindow));
		...
		protected ContextMenu GetSpotContextMenu(LayoutModelArea area, LayoutHitTestResult hitTestResult) {
			...
			foreach(ModelComponent component in hitTestResult.Selection) {
				if(ComponentContextMenuAddTopEntriesEventName != null)
					EventManager.Event(new LayoutEvent(component, ComponentContextMenuAddTopEntriesEventName, null, menu));

				object queryResult = EventManager.Event(new LayoutEvent(component, ComponentContextMenuQueryEventName, null, false).SetFrameWindow(hitTestResult.FrameWindow));
			...
			if(components.Count <= 1) {
				...
				foreach(ModelComponent component in hitTestResult.Selection) {
					if(components.Contains(component))
						EventManager.Event(new LayoutEvent(component, ComponentContextMenuAddEntriesEventName, null, menu).SetFrameWindow(hitTestResult.FrameWindow));
					...
					if(ComponentContextMenuQueryCanRemoveEventName != null)
						componentCanBeRemoved = (bool)EventManager.Event(
							new LayoutEvent(component, ComponentContextMenuQueryCanRemoveEventName, null, true).SetFrameWindow(hitTestResult.FrameWindow));
				...
				foreach(ModelComponent component in hitTestResult.Selection) {
					...
					if(ComponentContextMenuQueryNameEventName != null)
						componentMenuName = (String)EventManager.Event(
							new LayoutEvent(component, ComponentContextMenuQueryNameEventName, null,
								component.ToString()).SetFrameWindow(hitTestResult.FrameWindow));
					else
						componentMenuName = component.ToString();

					MenuItem	componentContextMenu = new MenuItem(componentMenuName);

					EventManager.Event(new LayoutEvent(component, ComponentContextMenuAddEntriesEventName, null,
						componentContextMenu).SetFrameWindow(hitTestResult.FrameWindow));
			...
			if(ComponentContextMenuAddBottomEntriesEventName != null) {
				int		n = menu.MenuItems.Count;

				foreach(ModelComponent component in hitTestResult.Selection)
					EventManager.Event(new LayoutEvent(component, ComponentContextMenuAddBottomEntriesEventName, null, menu).SetFrameWindow(hitTestResult.FrameWindow));
			}

			if(ComponentContextMenuAddCommonEntriesEventName != null)
				EventManager.Event(
					new LayoutEvent(hitTestResult, ComponentContextMenuAddCommonEntriesEventName, null, menu).SetFrameWindow(hitTestResult.FrameWindow));
