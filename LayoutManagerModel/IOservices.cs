...
namespace LayoutManager.Components {
	...
	public class LayoutIOServices : LayoutModuleBase {
		...
		private void openSerialCommunicationDeviceRequest(LayoutEvent e) {
			...
			commTimeouts.ReadIntervalTimeout = GetNumber(setupElement, "ReadInternalTimeout");
			commTimeouts.ReadTotalTimeoutConstant = GetNumber(setupElement, "ReadTotalTimeoutConstant");
			commTimeouts.ReadTotalTimeoutMultiplier = GetNumber(setupElement, "ReadTotalTimeoutMultiplier");
			commTimeouts.WriteTotalTimeoutConstant = GetNumber(setupElement, "WriteTotalTimeoutMultiplier");
