...
namespace LayoutManager.View
{
	...
	public class ComponentViews : System.ComponentModel.Component, ILayoutModuleSetup
	{
		...
		void GetBlockInfoRegions(LayoutEvent eBase) {
			LayoutGetDrawingRegionsEvent	e = (LayoutGetDrawingRegionsEvent)eBase;
			LayoutBlockDefinitionComponent	blockDefinition = (LayoutBlockDefinitionComponent)e.Component;
			...
			if(LayoutController.IsOperationMode && blockDefinition.Block != null && blockDefinition.Block.HasTrains) {
				...
				if(LayoutController.IsOperationMode && blockDefinition.Info.UnexpectedTrainDetected) {
					...
					locoPainter.Front = blockDefinition.Track.ConnectionPoints[0];
		...
		private void getPowerSelectorConnectionPointImage(LayoutEvent e) {
			LayoutPowerSelectorComponent component = e.Sender as LayoutPowerSelectorComponent;
		...
		private void getGateConnectionPointImage(LayoutEvent e) {
			var component = e.Sender as LayoutGateComponent;
