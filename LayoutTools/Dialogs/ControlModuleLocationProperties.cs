...
namespace LayoutManager.Tools.Dialogs
{
	...
	public class ControlModuleLocationProperties : Form, ILayoutComponentPropertiesDialog
	{
		...
		private void buttonOK_Click(object sender, System.EventArgs e) {
			...
			info.CommandStationId = ((CommandStationItem)comboBoxCommandStation.SelectedItem).ID;
		...
		class Item : ListViewItem {
			ControlModuleLocationBusDefaultInfo	busDefault;
		...
		class AddDefaultMenuItem : MenuItem {
			ControlModuleLocationProperties	dialog;
			ControlBus						bus;
