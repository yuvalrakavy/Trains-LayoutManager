...
namespace LayoutManager.Tools.Dialogs {
    ...
    public class DefaultDrivingParameters : Form {
        ...
        public DefaultDrivingParameters() {
            ...
            motionRampWithCopyEditorAcceleration.Ramp = d.AccelerationProfile;
            motionRampWithCopyEditorDeceleration.Ramp = d.DecelerationProfile;

            textBoxSlowdown.Text = d.SlowdownSpeed.ToString();
            labelSlowdownValues.Text = "(1-" + LayoutModel.Instance.LogicalSpeedSteps + ")";

            motionRampWithCopyEditorSlowdown.Ramp = d.SlowdownProfile;
            motionRampWithCopyEditorStop.Ramp = d.StopProfile;
        }
