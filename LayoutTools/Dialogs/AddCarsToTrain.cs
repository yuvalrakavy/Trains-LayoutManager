...
namespace LayoutManager.Tools.Dialogs {
    ...
    public class AddCarsToTrain : Form {
        ...
        private void setLength(double carLength) {
            ...
            foreach (Control c in groupBoxLength.Controls) {
                if (c is RadioButton rb) {
                    ...
                    if (underline >= 0) {
                        double rbLength = Double.Parse(rb.Name.Substring(underline + 1));
            ...
            if (radioButtonOther.Checked)
                ...
                foreach (Control c in groupBoxLength.Controls) {
                    if (c is RadioButton rb && rb.Checked) {
                        ...
                        if (underline >= 0)
                            return Double.Parse(rb.Name.Substring(underline + 1));
                    }
                }
        ...
        private void InitializeComponent() {
            ...
            this.lengthInput.Enter += new System.EventHandler(this.lengthInput_Enter);
            // 
