...
namespace LayoutManager.Tools.Dialogs
{
	...
	/// </summary>
	public class TripPlanCommonDestinations : System.Windows.Forms.Form
	{
		...
		ILayoutSelectionLook	destinationSelectionLook = new LayoutSelectionLook(Color.Orange);
		LayoutSelection			selectedLocationSelection;
		ILayoutSelectionLook	selectedLocationSelectionLook = new LayoutSelectionLook(Color.OrangeRed); 
		...
		private void editDestination(DestinationNode destinationNode) {
			...
			destinationEditor.HideSaveButton = true;
